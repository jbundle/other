...
import org.jbundle.util.other.loaddist.samplermi.*;


/**
 * Remote object to receive calls forwarded from the ServletHandler.
 */
public class ForwardRMIServer extends java.rmi.server.UnicastRemoteObject implements SampleRMI
{

    public ForwardRMIServer() throws RemoteException 
    {
    }

    public String justPass(String passed) throws RemoteException
    {
	    passed = sampleRMI.justPass(passed);
	...
	try {
        ...
        ForwardRMIServer app = new ForwardRMIServer();
		try {
	     ...
	     app.sampleRMI = (SampleRMI) Naming.lookup("rmi://" + args[1] + "/SampleRMI");
    ...
    public SampleRMI sampleRMI = null;
    ...
    public SampleRMI makeaNewOne() throws java.rmi.RemoteException
    {
        ...
        ForwardRMIServer sample = new ForwardRMIServer();
        sample.sampleRMI = this.sampleRMI.makeaNewOne();
        return sample;
//        return sampleRMI.makeaNewOne();
    }
