...
public class MemoryMonitor extends JPanel {
    ...
    public MemoryMonitor(ProcessMonitor processMonitor) {
        setLayout(new BorderLayout());
        setBorder(new TitledBorder(new EtchedBorder(), "Memory Monitor"));
        add(surf = new Surface(processMonitor));
        controls = new JPanel();
    ...
    public class Surface extends JPanel implements Runnable {
		...
		private ProcessMonitor m_processMonitor = null;

        public Surface(ProcessMonitor processMonitor) {
        ...
        public void paint(Graphics g) {
			...
			try	{
            	freeMemory = (float)m_processMonitor.getCurrentLoad();
            	totalMemory = (float)m_processMonitor.getMaximumLoad();
    ...
    public static void main(String s[]) {
        final MemoryMonitor demo = new MemoryMonitor(null);
